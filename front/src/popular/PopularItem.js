                ...
                <span className="tagclass">
                    {this.props.week > 0 &&
                        <span>
                            ...
                            <span className="content-item3" >{this.props.item.likes}</span>
                            <span className={"content-icon-" + this.state.dislikesFlag}>싫어</span>
                            <span className="content-item3" >{this.props.item.dislikes}</span>
